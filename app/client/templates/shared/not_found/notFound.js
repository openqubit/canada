...
console.log('retrievedObject: ', JSON.parse(retrievedObject));
  ...
  'click #cart': function() {
   ...
   $.each(ki, function (index, value) {
   	...
   	$("#sk").append("<li><a href='#'' class='item-link'><div class='item-content'><div class='item-inner'><div class='item-title'>"+index+"-----Quantity  "+value+"------Total Amount"+value+"</div></div></div></a></li>");
